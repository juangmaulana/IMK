    ...
    <div className="flex min-h-screen items-center justify-center bg-hero px-6 py-12">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-card">
        ...
        >
          ...
          {success && <div className="rounded-md bg-green-500/10 p-2 text-center text-sm font-medium text-green-600">Akun berhasil dibuat! Mengarah ke halaman login</div>}
